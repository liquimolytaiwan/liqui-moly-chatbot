 ...
 */
const AI_DISCLAIMER = {
    // 繁體中文版本（用於網頁端和 META 端）
    'zh-TW': '\n\n⚠️ AI 助理的回覆僅供參考，可能會有錯誤。如有疑問，請以車主手冊或專業技師建議為準。',
    // 英文版本
    'en': '\n\n⚠️ AI assistant responses are for reference only and may contain errors. Please consult your owner\'s manual or a professional technician for confirmation.',
    // 日文版本
    'ja': '\n\n⚠️ AIアシスタントの回答は参考用であり、誤りを含む場合があります。ご不明な点は、オーナーズマニュアルまたは専門技術者にご確認ください。',
    // 韓文版本
    'ko': '\n\n⚠️ AI 어시스턴트의 답변은 참고용이며 오류가 있을 수 있습니다. 궁금한 점은 차량 매뉴얼이나 전문 기술자에게 문의하세요.',
    // 向後相容 - 保留舊的 key
    web: '\n\n⚠️ AI 助理的回覆僅供參考，可能會有錯誤。如有疑問，請以車主手冊或專業技師建議為準。',
    meta: '\n\n⚠️ AI 助理的回覆僅供參考，可能會有錯誤。如有疑問，請以車主手冊或專業技師建議為準。'
};
