...
**絕對禁止以下行為：**
1. ❌ **禁止組合產品名稱**：不得將資料庫中的產品 A 和產品 B 的名稱混合
   - 錯誤範例：「Motorbike 4T Synth 5W-40 Street 街道型摩托車機油」（不存在此產品！）
2. ❌ **禁止猜測產品名稱**：不得根據黏度、認證等資訊「創造」產品名
3. ❌ **禁止縮寫或改寫產品名**：必須完整引用資料庫中的產品標題

**正確做法：**
- ✅ 複製貼上「可用產品資料庫」中的完整產品標題
- ✅ 如果資料庫中找不到完全符合的產品，說明「目前資料庫未顯示該產品」
